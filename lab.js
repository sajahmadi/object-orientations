...
function greeting( obj ) {
  //Code Here
  let {firstName, lastName, title} = object
  // Do not edit the code below.
...
castSpell(){
  console.log(this.name, this.favoriteSpell);
}}
...
let phone1 = new Phone('Google', 'Pixel', 100, '__blue', 700)
